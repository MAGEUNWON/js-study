...
const fromInputArray :string[] = [...fromInputJoin]
// 배열로 묶음. 
...
const reduce  = fromInputArray.reduce((accu:Obj,curr):Obj=> {
...
let joinStr = randomArray.join("");
console.log(joinStr);
// 배열을 다시 합쳐줌

let fiveChunk = [];
for(let i=0; i<joinStr.length; i+=5){
